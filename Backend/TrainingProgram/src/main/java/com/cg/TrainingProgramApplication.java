...
public class TrainingProgramApplication {
	...
	private ApiInfo myApiInfo() {
		// for version 2.9.1
		ApiInfo apiInfo = new ApiInfo("Training Program microservice API", 
				"API documentation of Training Program microservice", "1.0", 
				"Free to Use",
				new Contact("Shekhar", "/", "shekharkankale@gmail.com"),
				"API licence", 
				"/",
